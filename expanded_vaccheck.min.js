javascript: (function() {
    ...
    function getId(a) {
		...
		var c = a.querySelectorAll("div.playerNickname")[0].firstChild;
		var c = c.attributes.getNamedItem('data-miniprofile').value;
        return add(b, c)
    }
    var h = [].slice.call(document.querySelectorAll('#personaldata_elements_container td.commends_inner_name'));
    var j = {};
    ...
    function setVacation(e) {
        ...
        f.forEach(function(a) {
            var b = a.querySelector('.linkFriend_in-game');
